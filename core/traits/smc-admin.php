...
trait SMC_Admin {
    ...
    public function admin_menu() {
        add_menu_page(
            ...
            File_Handler::safe_url( SMC_Plugin_Globals::getPage('admin-menu')['icon'] ),
            '58'
        );
    }
            ...
            <form action="" method="POST" id="smc-addel-settings" name="smc-addel-settings">
                <div class="smc-addel-header-bar">
                    ...
                    <div class="smc-addel-header-right">
                        <button type="submit"
                                class="button smc-addel-btn js-smc-addel-settings-save"><?php echo __( 'Save settings', $textdomain ); ?></button>
